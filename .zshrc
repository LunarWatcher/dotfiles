...
# }}}
# Uncategorised stuff{{{
# I do not understand what extended_glob does, but all the decent guides say to use it, and the 
# wiki shows some cursed zsh I don't understand, but I guess it doesn't hurt
